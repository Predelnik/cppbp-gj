...
public:
  ...
  [[nodiscard]] double sq_length() const { return x * x + y * y + z * z; }

  [[nodiscard]] Point3F normalized() const { return *this / length(); }
  Point3F operator-() const { return { -x, -y, -z }; }
  ...
  [[nodiscard]] double dot(const Point3F &other) const { return x * other.x + y * other.y + z * other.z; }
};
